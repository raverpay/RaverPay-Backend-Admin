---
name: Alchemy Mobile App Implementation Plan
overview: Complete mobile app implementation for Alchemy EOA wallets, following existing patterns (Circle wallet implementation). Includes all screens, services, hooks, stores, and components needed for a production-ready crypto wallet experience.
todos:
  - id: api-endpoints
    content: Add ALCHEMY endpoints to API_ENDPOINTS in lib/api/endpoints.ts
    status: pending
  - id: types
    content: Create alchemy.types.ts with all TypeScript definitions
    status: pending
  - id: service
    content: Create alchemy.service.ts following circle.service.ts pattern
    status: pending
  - id: store
    content: Create alchemy.store.ts Zustand store following circle.store.ts pattern
    status: pending
  - id: hooks
    content: Create useAlchemy.ts with all React Query hooks
    status: pending
  - id: wallet-card
    content: Create AlchemyWalletCard component
    status: pending
  - id: network-selector
    content: Create NetworkSelector component
    status: pending
  - id: seed-phrase-display
    content: Create SeedPhraseDisplay component with security
    status: pending
  - id: transaction-item
    content: Create TransactionItem component
    status: pending
  - id: gas-price-display
    content: Create GasPriceDisplay component
    status: pending
  - id: dashboard-screen
    content: Create app/alchemy/index.tsx main dashboard
    status: pending
  - id: onboarding-screen
    content: Create app/alchemy/onboarding.tsx carousel
    status: pending
  - id: create-screen
    content: Create app/alchemy/create.tsx wallet creation flow
    status: pending
  - id: import-screen
    content: Create app/alchemy/import.tsx wallet import flow
    status: pending
  - id: seed-backup-screen
    content: Create app/alchemy/seed-phrase-backup.tsx with verification
    status: pending
  - id: wallet-detail-screen
    content: Create app/alchemy/wallet/[id].tsx detail screen
    status: pending
  - id: send-screen
    content: Create app/alchemy/send.tsx transaction flow
    status: pending
  - id: receive-screen
    content: Create app/alchemy/receive.tsx QR code screen
    status: pending
  - id: transaction-details-screen
    content: Create app/alchemy/transaction/[id].tsx details
    status: pending
  - id: transaction-history-screen
    content: Create app/alchemy/transactions.tsx history list
    status: pending
  - id: settings-screen
    content: Create app/alchemy/settings/[id].tsx wallet settings
    status: pending
  - id: qr-scanner
    content: Install expo-camera and create QRCodeScanner component
    status: pending
  - id: pin-integration
    content: Integrate PIN/biometric verification for sensitive operations
    status: pending
  - id: navigation
    content: Add Alchemy routes to app navigation
    status: pending
  - id: error-handling
    content: Implement comprehensive error handling
    status: pending
  - id: loading-states
    content: Add loading indicators throughout app
    status: pending
  - id: testing
    content: Test all user flows end-to-end
    status: pending
  - id: polish
    content: Polish UI/UX and handle edge cases
    status: pending
isProject: false
---
