...
export const getSeverityForAction = (action: AuditAction): AuditSeverity => {
  const criticalActions = [
    ...
    AuditAction.ALCHEMY_SEED_PHRASE_EXPORTED,
  ];
  ...
  const mediumActions = [
    ...
    AuditAction.ALCHEMY_WALLET_CREATED,
    AuditAction.STABLECOIN_WALLET_CREATED,
    AuditAction.STABLECOIN_DEPOSIT_RECEIVED,
    AuditAction.ALCHEMY_WEBHOOK_FAILED,
  ];
