      ...
      <View className="flex-1 bg-gray-50 dark:bg-gray-900">
        ...
        >
          ...
          <View className="px-6 gap-4">
            ...
            <Card variant="elevated" pressable onPress={handleSelectCustodial} className="p-5">
              <View className="flex-row">
                ...
                <View className="flex-1">
                  ...
                  <View className="bg-green-100 dark:bg-green-900/30 px-2 py-0.5 rounded-full self-start mb-3">
                    <Text variant="h9" className="text-green-700 dark:text-green-400">
                      Recommended for beginners
                    </Text>
                  </View>
                  <Text variant="caption" color="secondary" className="mb-4">
                    We manage your wallet for you. Simple and secure - perfect if you&apos;re new to
                    crypto.
                  </Text>
            ...
            <Card variant="elevated" pressable onPress={handleSelectNonCustodial} className="p-5">
              <View className="flex-row">
                ...
                <View className="flex-1">
                  ...
                  <View className="bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 rounded-full self-start mb-3">
                    <Text variant="h9" className="text-blue-700 dark:text-blue-400">
                      Full control
                    </Text>
                  </View>
                  <Text variant="caption" color="secondary" className="mb-4">
                    You control your wallet completely. Required for gas-free transactions with
                    Paymaster.
                  </Text>
            ...
            <Card variant="elevated" pressable onPress={handleSelectModular} className="p-5">
              <View className="flex-row">
                ...
                <View className="flex-1">
                  ...
                  <View className="bg-purple-100 dark:bg-purple-900/30 px-2 py-0.5 rounded-full self-start mb-3">
                    <Text variant="h9" className="text-purple-700 dark:text-purple-400">
                      ⚡ Pay gas in USDC
                    </Text>
                  </View>
                  <Text variant="caption" color="secondary" className="mb-4">
                    Smart wallet with biometric security. Pay transaction fees in USDC instead of
                    native tokens.
                  </Text>
          ...
          <View className="px-6 mt-6">
            <Card variant="filled" className="p-4 flex-row items-start">
              ...
              <View className="flex-1">
                <Text variant="h7" weight="bold" className="text-blue-700 dark:text-blue-400 mb-1">
                  You can create both types
                </Text>
                <Text variant="caption" className="text-blue-600 dark:text-blue-300">
                  You&apos;re not limited to one wallet type. You can create and use both Easy and
                  Advanced wallets in your account.
                </Text>
              </View>
            </Card>
          </View>
