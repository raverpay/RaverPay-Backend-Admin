...
export const QRCodeDisplay: React.FC<QRCodeDisplayProps> = ({ address, size = 250 }) => {
  ...
  return (
    <View className="items-center">
      ...
      <Card variant="outlined" pressable onPress={copyToClipboard} className="mb-3">
        <View className="flex-row items-center justify-center px-4 py-3">
          <Text variant="body" className="font-mono text-center">
            {address.slice(0, 6)}...{address.slice(-4)}
          </Text>
          <Ionicons name="copy-outline" size={18} color="#6B7280" style={{ marginLeft: 8 }} />
        </View>
      </Card>
    </View>
  );
